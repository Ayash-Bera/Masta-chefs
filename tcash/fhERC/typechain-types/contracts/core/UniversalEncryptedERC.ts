...
export interface UniversalEncryptedERCInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "alreadyMinted"
  ...
  encodeFunctionData(
    functionFragment: "nativeBalances",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export namespace NativeDepositEvent {
  ...
  export type OutputTuple = [user: string, amount: bigint, tokenId: bigint];
  export interface OutputObject {
    user: string;
    amount: bigint;
    tokenId: bigint;
...
export namespace NativeWithdrawEvent {
  export type InputTuple = [
    user: AddressLike,
    amount: BigNumberish,
    tokenId: BigNumberish
...
export interface UniversalEncryptedERC extends BaseContract {
  connect(runner?: ContractRunner | null): UniversalEncryptedERC;
  waitForDeployment(): Promise<this>;

  interface: UniversalEncryptedERCInterface;
  ...
  getNativeBalance: TypedContractMethod<[user: AddressLike], [bigint], "view">;
  ...
  nativeBalances: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  registerTokenType: TypedContractMethod<
    [tokenAddress: AddressLike, tokenType: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "nativeBalances"
  ...
  getEvent(
    ...
    NativeWithdrawEvent.InputTuple,
    NativeWithdrawEvent.OutputTuple,
    NativeWithdrawEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "Deposit(address,uint256,uint256,uint256,uint8)": TypedContractEvent<
      DepositEvent.InputTuple,
      DepositEvent.OutputTuple,
      DepositEvent.OutputObject
    >;
    ...
    "NativeDeposit(address,uint256,uint256)": TypedContractEvent<
      NativeDepositEvent.InputTuple,
      NativeDepositEvent.OutputTuple,
      NativeDepositEvent.OutputObject
    >;
    ...
    "NativeWithdraw(address,uint256,uint256)": TypedContractEvent<
      NativeWithdrawEvent.InputTuple,
      NativeWithdrawEvent.OutputTuple,
      NativeWithdrawEvent.OutputObject
    >;
    NativeWithdraw: TypedContractEvent<
      NativeWithdrawEvent.InputTuple,
      NativeWithdrawEvent.OutputTuple,
      NativeWithdrawEvent.OutputObject
    >;
